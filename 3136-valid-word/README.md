<h2><a href="https://leetcode.com/problems/valid-word/?envType=problem-list-v2&envId=string">3136. Valid Word</a></h2><h3>Easy</h3><hr><p>A word is considered <strong>valid</strong> if:</p>
